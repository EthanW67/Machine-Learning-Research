...
Train the Model
"""
model = LinearAutoencoder(in_channels=1, out_channels=1).to(device)
...
checkpoint_path = '/home/ys92/EthanSURF/SURF_Research/SURF_Final/cond_diffu_CTs/LAE_savemodels/checkpoint.pth'
